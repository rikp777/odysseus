...
def setup_chat_routes(
    ...
    async def chat_endpoint(request: Request, chat_request: ChatRequest) -> Dict[str, str]:
        ...
        direct_tool_allowed = bool(
            tool_intent
            and tool_intent.kind == "direct_tool"
            and not tool_policy.blocks(tool_intent.tool or "")
        )
    ...
    async def chat_stream(request: Request) -> StreamingResponse:
        ...
        async def stream_with_save() -> AsyncGenerator[str, None]:
            ...
            if (
                direct_tool_intent
                and not tool_policy.blocks(direct_tool_intent.tool or "")
                and not do_research
                        ...
                        if chunk.startswith("data: ") and not chunk.startswith("data: [DONE]"):
                            ...
                            if full_response:
                                ...
                                record_llm_usage_safely(
                                    ...
                                    model=last_metrics.get("model") or _actual_model or _answered_by or _requested_model,
