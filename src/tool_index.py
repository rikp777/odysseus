...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_billing": "Show cloud billing status, spending graphs, and billing-linked usage breakdowns in chat. Use for current spend, monthly spend, cloud costs, provider/model billing usage, budget/limit/warning progress, and requests like 'show me a spending graph'. Returns a ready-to-render billing-chart block.",
    ...
    "manage_logbook": "Read the user's owner-scoped Daily Logbook. Use for diary/journal/logbook recall, what happened on a date or day, timelines, when a person was seen or mentioned, who a logbook person is, who the user has not seen or mentioned lately, who to message/reach out/check in with, where something happened, places/locations, mood history, and datapoints such as sleep, energy, stress, workout, pain, food, work, medication, and gratitude. Read-only; cite dates; suggested connections are not facts unless accepted.",
...
class ToolIndex:
    ...
    _KEYWORD_HINTS = {
        ...
        frozenset({"note", "todo", "reminder", "remind", "checklist", "remember to"}):
            {"manage_notes"},
        frozenset({"logbook", "daily log", "journal", "diary", "what happened",
                   "that day", "which day", "when did", "last time",
                   "timeline", "mood", "energy", "stress", "sleep",
                   "workout", "gratitude", "datapoint", "mentioned",
                   "talked to", "met", "saw", "place", "places",
                   "location", "locations", "where was", "who is",
                   "person", "people", "not seen", "reach out",
                   "check in", "meet up", "meetup", "who should i message"}):
            {"manage_logbook"},
