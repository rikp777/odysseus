...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "manage_billing": "Show cloud billing status and spending graphs in chat. Use for current spend, monthly spend, cloud costs, provider billing, budget/limit/warning progress, and requests like 'show me a spending graph'. Returns a ready-to-render billing-chart block.",
