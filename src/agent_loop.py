...
- "What happened on <date/day>", "when did I see/talk to <person>", "where was I", "show my journal/logbook", mood/datapoint history, people/places from daily entries → use `manage_logbook`. It is read-only diary evidence; cite dates and do not present suggested person connections as facts unless accepted.
...
```
Read-only Daily Logbook recall. Use for journal/logbook/diary questions, "what happened on <date/day>", "when did I see/talk to <person>", places/locations, mood, sleep/energy/stress/workout/gratitude datapoints, timelines, and accepted/suggested person connections. Actions: `get_day`, `list_range`, `timeline`, `search`, `people`, `places`, `directories`, `connections`. Filters: date/start/end/q/person/place/mood/datapoint_key/status/limit. Cite dates. Treat suggested connections cautiously; only accepted connections are user-confirmed.""",
